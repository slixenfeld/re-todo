	...
	public void setup_ui_components() {
		...
		delete_button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {Config.properties.remove(task_name_field.getText()+"_repeating");} catch (Exception e2) {};
				try {Config.properties.remove(task_name_field.getText()+"_category");} catch (Exception e2) {};
